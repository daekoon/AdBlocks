    ...
    return function e(t, n, o) {
            ...
            !function() {
                ...
                o.scale = function(e, n, r, s) {
                    for (var a = 0; a < e.parts.length; a++) {
                        var u = e.parts[a];
                        i.scale(u.vertices, n, r, e.position),
                        u.axes = c.fromVertices(u.vertices),
                        e.isStatic || (u.area = i.area(u.vertices),
                        o.setMass(u, e.density * u.area),
                        i.translate(u.vertices, {
                            x: -u.position.x,
                            y: -u.position.y
                        }),
                        o.setInertia(u, i.inertia(u.vertices, u.mass)),
                        i.translate(u.vertices, {
                            x: u.position.x,
                            y: u.position.y
                        })),
                ...
                o.update = function(e, t, n, o) {
                    ...
                    e.velocity.x = u * a * o + e.force.x / e.mass * s,
                    e.velocity.y = d * a * o + e.force.y / e.mass * s,
        ...
        2: [function(e, t, n) {
            ...
            !function() {
                ...
                o.removeComposite = function(e, t, n) {
                    ...
                    if (i !== -1 && (o.removeCompositeAt(e, i),
                    o.setModified(e, !0, !0, !1)),
                    n)
                ...
                o.removeConstraint = function(e, t, n) {
                    ...
                    if (i !== -1 && o.removeConstraintAt(e, i),
                    n)
                        for (var s = 0; s < e.composites.length; s++)
        ...
        6: [function(e, t, n) {
            ...
            !function() {
                ...
                o.update = function(n, o, i, r) {
                    var s, p, f, m, v, y = i.world, g = n.buckets, x = !1;
            ...
            !function() {
                ...
                o.update = function(e, t, n) {
                    ...
                    t.collided) {
                        ...
                        e.isActive === !0 && o.setActive(e, !1, n)
                }
                ,
        ...
        8: [function(e, t, n) {
            ...
            !function() {
                ...
                ,
                o.update = function(e, t, n) {
                    var o, s, a, l, c = e.list, u = e.table, d = e.collisionStart, p = e.collisionEnd, f = e.collisionActive, m = [];
                    for (d.length = 0,
                    p.length = 0,
                    f.length = 0,
                    l = 0; l < t.length; l++)
                        o = t[l],
                        o.collided && (s = i.id(o.bodyA, o.bodyB),
                        m.push(s),
                        a = u[s],
                        a ? (a.isActive ? f.push(a) : d.push(a),
                    ...
                    for (l = 0; l < c.length; l++)
                        a = c[l],
                        a.isActive && r.indexOf(m, a.id) === -1 && (i.setActive(a, !1, n),
                        p.push(a))
                }
                ,
                o.removeOld = function(t, n) {
                    var o, i, r, s, a = t.list, l = t.table, c = [];
                    for (s = 0; s < a.length; s++)
                        o = a[s],
                        i = o.collision,
                        i.bodyA.isSleeping || i.bodyB.isSleeping ? o.timeUpdated = n : n - o.timeUpdated > e && c.push(s);
            ...
            !function() {
                ...
                o.preSolvePosition = function(e) {
                    ...
                    for (t = 0; t < e.length; t++)
                        n = e[t],
                        n.isActive && (o = n.activeContacts.length,
                        n.collision.parentA.totalContacts += o,
                        n.collision.parentB.totalContacts += o)
                }
                ,
                o.solvePosition = function(e, t) {
                    var n, i, s, a, l, c, u, d, p, f = r._temp[0], m = r._temp[1], v = r._temp[2], y = r._temp[3];
                    for (n = 0; n < e.length; n++)
                        i = e[n],
                        i.isActive && !i.isSensor && (s = i.collision,
                        a = s.parentA,
                        l = s.parentB,
                        c = s.normal,
                        u = r.sub(r.add(l.positionImpulse, l.position, f), r.add(a.positionImpulse, r.sub(l.position, s.penetration, m), v), y),
                        i.separation = r.dot(c, u));
                    for (n = 0; n < e.length; n++)
                        i = e[n],
                        !i.isActive || i.isSensor || i.separation < 0 || (s = i.collision,
                        a = s.parentA,
                        l = s.parentB,
                        c = s.normal,
                        p = (i.separation - i.slop) * t,
                        (a.isStatic || l.isStatic) && (p *= 2),
                        a.isStatic || a.isSleeping || (d = o._positionDampen / a.totalContacts,
                        a.positionImpulse.x += c.x * p * d,
                        a.positionImpulse.y += c.y * p * d),
                        l.isStatic || l.isSleeping || (d = o._positionDampen / l.totalContacts,
                ...
                o.preSolveVelocity = function(e) {
                    var t, n, o, i, s, a, l, c, u, d, p, f, m, v, y = r._temp[0], g = r._temp[1];
                    for (t = 0; t < e.length; t++)
                        if (o = e[t],
                        o.isActive && !o.isSensor)
                        ...
                        if (f.isActive && !f.isSensor) {
                            ...
                            for (var w = 0; w < h.length; w++) {
                                var S = h[w]
                                  ...
                                  , F = T
                                  , O = 1 / 0;
                                V > f.friction * f.frictionStatic * E * n && (O = V,
                                F = s.clamp(f.friction * R * n, -O, O));
                                var L = r.cross(A, g)
                                  , W = r.cross(P, g)
            ...
            !function() {
                o.collides = function(t, o, s) {
                    ...
                    if (s && d) {
                        ...
                        if (a = e(t.vertices, o.vertices, t.axes),
                        a.overlap <= 0)
                            return u.collided = !1,
                            u;
                        if (l = e(o.vertices, t.vertices, o.axes),
                        l.overlap <= 0)
                            return u.collided = !1,
                            u;
                        ...
                        u.axisBody = t) : (c = l,
                        u.axisBody = o),
                        u.axisNumber = c.axisNumber;
                    }
                    u.bodyA = t.id < o.id ? t : o,
                    u.bodyB = t.id < o.id ? o : t,
                    u.collided = !0,
                    u.depth = c.overlap,
                    u.parentA = u.bodyA.parent,
                    u.parentB = u.bodyB.parent,
                    t = u.bodyA,
                    o = u.bodyB,
                    r.dot(c.axis, r.sub(o.position, t.position)) < 0 ? u.normal = {
                        x: c.axis.x,
                        y: c.axis.y
                    } : u.normal = {
                        x: -c.axis.x,
                    ...
                    u.tangent = r.perp(u.normal),
                    u.penetration = u.penetration || {},
                    u.penetration.x = u.normal.x * u.depth,
                    u.penetration.y = u.normal.y * u.depth;
                ...
                var e = function(e, n, o) {
                  ...
                  , n = function(e, t, n) {
                    for (var o, i, s, a, l = Number.MAX_VALUE, c = r._temp[0], u = t.vertices, d = e.position, p = 0; p < u.length; p++)
                        i = u[p],
                        c.x = i.x - d.x,
                        c.y = i.y - d.y,
                        o = -r.dot(n, c),
        ...
        12: [function(e, t, n) {
            ...
            !function() {
                ...
                o.create = function(t) {
                    ...
                    return n.render = c.extend(a, n.render),
                    n.id = n.id || c.nextId(),
                ...
                o.solve = function(n, o) {
                    var i = n.bodyA
                      ...
                      , a = n.pointA
                      , l = n.pointB;
                    i && !i.isStatic && (n.pointA = r.rotate(a, i.angle - n.angleA),
                    n.angleA = i.angle),
                    s && !s.isStatic && (n.pointB = r.rotate(l, s.angle - n.angleB),
                    n.angleB = s.angle);
                    var c = a
                      , u = l;
                    if (i && (c = r.add(i.position, a)),
                    s && (u = r.add(s.position, l)),
                    c && u) {
                        var d = r.sub(c, u)
                          , p = r.magnitude(d);
                        0 === p && (p = e);
                        ...
                        if (!(Math.abs(1 - p / n.length) < t * o)) {
                            ...
                            g = r.add(s.velocity, r.mult(r.perp(h), s.angularVelocity)),
                            w = r.dot(h, m),
                            C = s.inverseMass + s.inverseInertia * w * w) : (g = {
                                x: 0,
                                y: 0
                            },
                            C = s ? s.inverseMass : 0);
                            ...
                            i && !i.isStatic && (B = r.cross(x, M) * i.inverseInertia * (1 - n.angularStiffness),
                            i.constraintImpulse.x -= v.x,
                            i.constraintImpulse.y -= v.y,
                            i.constraintImpulse.angle += B,
                            i.position.x -= v.x,
                            i.position.y -= v.y,
                            i.angle += B),
                            s && !s.isStatic && (B = r.cross(h, M) * s.inverseInertia * (1 - n.angularStiffness),
                            s.constraintImpulse.x += v.x,
                            s.constraintImpulse.y += v.y,
                            s.constraintImpulse.angle -= B,
                            s.position.x += v.x,
                            s.position.y += v.y,
                            s.angle -= B)
                        }
                    ...
                    for (var t = 0; t < e.length; t++) {
                        ...
                        if (0 !== o.x || 0 !== o.y || 0 !== o.angle) {
                            ...
                            for (var c = 0; c < n.parts.length; c++) {
                                var u = n.parts[c];
                                i.translate(u.vertices, o),
                                c > 0 && (u.position.x += o.x,
                                u.position.y += o.y),
                                0 !== o.angle && (i.rotate(u.vertices, o.angle, n.position),
                                l.rotate(u.axes, o.angle),
                                c > 0 && r.rotateAbout(u.position, o.angle, n.position, u.position)),
        ...
        15: [function(e, t, n) {
            ...
            !function() {
                ...
                o.update = function(o, i, a) {
                    i = i || 1e3 / 60,
                    a = a || 1;
                    var c, f = o.world, m = o.timing, v = o.broadphase, y = [];
                    ...
                    for (o.enableSleeping && r.update(x, m.timeScale),
                    t(x, f.gravity),
                    n(x, i, m.timeScale, a, f.bounds),
                    c = 0; c < o.constraintIterations; c++)
                        p.solveAll(h, m.timeScale);
                    p.postSolveAll(x),
                    v.controller ? (f.isModified && v.controller.clear(v),
                    v.controller.update(v, x, o, f.isModified),
                    y = v.pairsList) : y = x,
                    f.isModified && d.setModified(f, !1, !1, !0);
                    var b = v.detector(y, o)
                      , w = o.pairs
                      , S = m.timestamp;
                    for (l.update(w, b, S),
                    l.removeOld(w, S),
                    o.enableSleeping && r.afterCollisions(w.list, m.timeScale),
                    w.collisionStart.length > 0 && u.trigger(o, "collisionStart", {
        ...
        21: [function(e, t, n) {
            ...
            !function() {
                ...
                o.create = function(e) {
                    ...
                    n.deltaMax = n.deltaMax || 1e3 / (.5 * n.fps),
                    n.fps = 1e3 / n.delta,
                    n
                }
                ,
                o.run = function(t, n) {
                    return "undefined" != typeof t.positionIterations && (n = t,
                    t = o.create()),
                    function i(r) {
            ...
            (function(n) {
                ...
                !function() {
                    ...
                    o.trapezoid = function(e, t, n, o, a, l) {
                        l = l || {},
                        a *= .5;
                        var c, u = (1 - 2 * a) * n, d = n * a, p = d + u, f = p + d;
                        ...
                        if (l.chamfer) {
                            var v = l.chamfer;
                            m.vertices = i.chamfer(m.vertices, v.radius, v.quality, v.qualityMin, v.qualityMax),
                            delete l.chamfer
                        }
                    ...
                    o.fromVertices = function(e, t, n, o, u, d, p) {
                        ...
                        b = 0; b < n.length; b += 1)
                            ...
                            v || !c)
                                ...
                                c.makeCCW(S),
                                d !== !1 && c.removeCollinearPoints(S, d);
        ...
        27: [function(e, t, n) {
            ...
            !function() {
                o.pathToVertices = function(t, n) {
                    var o, i, r, s, a, l, c, u, d, p, f, m, v = [], y = 0, g = 0, x = 0;
                    n = n || 15;
        ...
        31: [function(e, t, n) {
            ...
            !function() {
                ...
                o.lookAt = function(e, t, n, o) {
                    ...
                    o && (e.bounds.min.x += .5 * d - d * g * .5,
                    e.bounds.max.x += .5 * d - d * g * .5,
                    e.bounds.min.y += .5 * p - p * x * .5,
                    e.bounds.max.y += .5 * p - p * x * .5),
                    e.bounds.min.x -= n.x,
                    e.bounds.max.x -= n.x,
                    e.bounds.min.y -= n.y,
                    e.bounds.max.y -= n.y,
                ...
                ,
                o.world = function(e) {
                    var t, n = e.engine, i = n.world, d = e.canvas, p = e.context, m = e.options, v = r.allBodies(i), y = r.allConstraints(i), g = m.wireframes ? m.wireframeBackground : m.background, x = [], h = [], b = {
                    ...
                    m.hasBounds) {
                        ...
                        h = y,
                        x = v;
                    !m.wireframes || n.enableSleeping && m.showSleeping ? o.bodies(e, x, p) : (m.showConvexHulls && o.bodyConvexHulls(e, x, p),
                ...
                o.bodyConvexHulls = function(e, t, n) {
                    ...
                    i = 0; i < t.length; i++)
                        if (o = t[i],
                        o.render.visible && 1 !== o.parts.length) {
                            ...
                            if (l.showAxes)
                                for (r = u.length > 1 ? 1 : 0; r < u.length; r++)
                                    ...
                                    s = 0; s < o.axes.length; s++) {
                                        ...
                                        a.lineTo(o.position.x + 20 * d.x, o.position.y + 20 * d.y)
                                    }
                            else
                                for (r = u.length > 1 ? 1 : 0; r < u.length; r++)
                                    for (o = u[r],
                ...
                o.bodyPositions = function(e, t, n) {
                    ...
                    r = 0; r < t.length; r++)
                        o = t[r],
                        o.render.visible && (a.arc(o.positionPrev.x, o.positionPrev.y, 2, 0, 2 * Math.PI, !1),
                        a.closePath());
                ...
                o.collisions = function(e, t, n) {
                    ...
                    r = 0; r < t.length; r++)
                        ...
                        o.activeContacts.length > 0)) {
                            ...
                            i.bodyB === i.supports[0].body || i.bodyA.isStatic === !0 ? a.moveTo(d - 8 * i.normal.x, p - 8 * i.normal.y) : a.moveTo(d + 8 * i.normal.x, p + 8 * i.normal.y),
                            a.lineTo(d, p)
                        }
                ...
                o.grid = function(e, t, n) {
                    var o = n
                      , r = e.options;
                    r.wireframes ? o.strokeStyle = "rgba(255,180,0,0.1)" : o.strokeStyle = "rgba(255,180,0,0.5)",
                    o.beginPath();
                ...
                var n = function(e, t) {
                  ...
                  , p = function(e, t) {
                    var n = e.textures[t];
                    return n ? n : (n = e.textures[t] = new Image,
                    n.src = t,
                    n)
                }
                  , f = function(e, t) {
        ...
        32: [function(e, t, n) {
            ...
            !function() {
                ...
                ,
                o.world = function(e) {
                    var t, n = e.engine, s = n.world, a = e.renderer, c = e.container, u = e.options, d = r.allBodies(s), p = r.allConstraints(s), f = [];
                    ...
                    if (u.hasBounds) {
                        ...
                        for (t = 0; t < p.length; t++) {
                            ...
                            S && C && (i.contains(e.bounds, S) || i.contains(e.bounds, C)) && f.push(h)
                        }
                        c.scale.set(1 / y, 1 / g),
                ...
                o.constraint = function(e, t) {
                    ...
                    t.bodyA)
                      ...
                      , c = "c-" + t.id
                      , u = e.primitives[c];
                    return u || (u = e.primitives[c] = new PIXI.Graphics),
                    l.visible && t.pointA && t.pointB ? (s.indexOf(a.children, u) === -1 && a.addChild(u),
                    u.clear(),
                    u.beginFill(0, 0),
                    u.lineStyle(l.lineWidth, s.colorToNumber(l.strokeStyle), 1),
                    n ? u.moveTo(n.position.x + i.x, n.position.y + i.y) : u.moveTo(i.x, i.y),
                    o ? u.lineTo(o.position.x + r.x, o.position.y + r.y) : u.lineTo(r.x, r.y),
                    void u.endFill()) : void u.clear()
                }
                ,
                o.body = function(e, t) {
                    var o = (e.engine,
                    ...
                    if (o.visible)
                        if (o.sprite && o.sprite.texture) {
                            ...
                            s.indexOf(a.children, r) === -1 && a.addChild(r),
                            ...
                            var l = "b-" + t.id
                              , u = e.primitives[l]
                              , d = e.container;
                            u || (u = e.primitives[l] = c(e, t),
                            u.initialAngle = t.angle),
                            s.indexOf(d.children, u) === -1 && d.addChild(u),
                            u.position.x = t.position.x,
                            u.position.y = t.position.y,
                            u.rotation = t.angle - u.initialAngle
                        }
                }
                ;
                var n = function(e, t) {
                    var n = t.render
                      ...
                      , i = u(e, o)
                      , r = new PIXI.Sprite(i);
                    return r.anchor.x = t.render.sprite.xOffset,
                    r.anchor.y = t.render.sprite.yOffset,
                    r
                }
                  , c = function(e, t) {
                    var n, o = t.render, i = e.options, r = new PIXI.Graphics, a = s.colorToNumber(o.fillStyle), l = s.colorToNumber(o.strokeStyle), c = s.colorToNumber(o.strokeStyle), u = s.colorToNumber("#bbb"), d = s.colorToNumber("#CD5C5C");
                    r.clear();
                    for (var p = t.parts.length > 1 ? 1 : 0; p < t.parts.length; p++) {
                        n = t.parts[p],
                        i.wireframes ? (r.beginFill(0, 0),
                        r.lineStyle(1, u, 1)) : (r.beginFill(a, 1),
                        ...
                        i.wireframes ? r.lineStyle(1, d, 1) : r.lineStyle(1, c),
